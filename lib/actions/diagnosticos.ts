...
export async function salvarDiagnosticoUfpa(familiaId: string, formData: FormData) {
  try {
    const diagnostico = {
      ...
      acoesPotenciaisProdutivo: getText(formData.get("acoesPotenciaisProdutivo")) || null,
      acoesPotenciaisSocial: getText(formData.get("acoesPotenciaisSocial")) || null,
      acoesPotenciaisAmbiental: getText(formData.get("acoesPotenciaisAmbiental")) || null,
      limitacoesProdutivo: getText(formData.get("limitacoesProdutivo")) || null,
      limitacoesSocial: getText(formData.get("limitacoesSocial")) || null,
      limitacoesAmbiental: getText(formData.get("limitacoesAmbiental")) || null,
