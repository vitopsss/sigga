        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">Atendimentos</h1>
              <p className="mt-1 text-sm text-slate-600">Histórico de visitas técnicas vinculadas a famílias do lote {ATER_SOCIOBIO_TERRITORY_NAME}.</p>
            </div>
