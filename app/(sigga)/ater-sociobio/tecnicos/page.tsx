        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900">Técnicos</h1>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
                Equipe de campo responsável pelo acompanhamento técnico das famílias no lote {ATER_SOCIOBIO_TERRITORY_NAME}.
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <Link href="/ater-sociobio/tecnicos/novo">
                <Button variant="primary">Novo técnico</Button>
              </Link>
            </div>
          </div>
        </section>
